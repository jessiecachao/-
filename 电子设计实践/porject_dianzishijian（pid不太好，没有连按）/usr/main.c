...
void main(void){
  ...
  unsigned char PA[8]={0xf1,0xf5,0x01,0x00,0xc5,0x00,0x00,0x00};
	...
	unsigned char pass_in[3]={0,0,0},pass[3]={1,1,1},wrong=1;
	unsigned char dat1;
	unsigned char key,i;
					...
					switch(menu_num){
						...
						case 3://改密码的地方
						{
							...
							switch(pa_menu_num){
								...
								case 2:LED[0]=0x00;LED[1]=0xf1;LED[2]=0x44;LED[3]=0x6d;LED[4]=0xf1;LED[5]=0xf5;LED[6]=0x01;LED[7]=0x00;break;//pid
							}
						}					    
							break;
						}
